...
class BasicPaymentExample implements IPaymentRequestExample
{
    ...
    public function __construct()
    {
        ...
        $paymentRequest->setUrlRetourErreur('http://localhost/igoguide/pro/paiement?ref=' . $generatedReference);
        $paymentRequest->setUrlRetourOK('http://localhost/igoguide/pro/paiement?ref=' . $generatedReference);
        /**
