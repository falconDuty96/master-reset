        ...
        <div class="__details_big_block">
            ...
            <div class="__banner">
                ...
                <div class="__gallery __gallery_5">
                    ...
                    <div class="__galery_masque" 
                            data-target="#galeryCarouselIndicators" data-slide-to="0" onclick="seeGaleryModal('galeryModal')"
                        ></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2017/12/16/22/22/bora-bora-3023437_640.jpg" alt="">
                    </div>
                    <div class="__images_2">
                    <div class="__galery_masque" 
                            data-target="#galeryCarouselIndicators" data-slide-to="1" onclick="seeGaleryModal('galeryModal')" 
                        ></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2015/04/01/01/56/bora-bora-701862_640.jpg" alt="">
                    </div>
                    <div class="__images_3">
                    <div class="__galery_masque" 
                            data-target="#galeryCarouselIndicators" data-slide-to="2" onclick="seeGaleryModal('galeryModal')"
                        ></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2017/07/26/19/42/bora-bora-2542917_640.jpg" alt="">
                    </div>
                    <div class="__images_4">
                    <div class="__galery_masque" 
                            data-target="#galeryCarouselIndicators" data-slide-to="3" onclick="seeGaleryModal('galeryModal')"
                        ></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2020/11/28/02/17/lagoon-5783445_640.jpg" alt="">
                    </div>
                    <div class="__images_5">
                    <div class="__galery_masque" 
                            data-target="#galeryCarouselIndicators" data-slide-to="4" onclick="seeGaleryModal('galeryModal')"
                        ></div>
    ...
    <div class="modal-dialog __modal_full_screen" role="document">
        <div class="modal-content __content">
            <div class="modal-header __modal_header">
                <p class="modal-title __modal_title" id="galeryModalLabel">
                    <span class="__number">10</span>
                    <span class="__text">Photos</span>
                </p>
        ...
        <div class="modal-body">
            <div id="galeryCarouselIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner __inner">
