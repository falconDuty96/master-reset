            ...
            <div class="__banner">
                ...
                <div class="__gallery" id="showing-images">
                    ...
                    <div class="__images_2">
                        <div class="__galery_masque" data-target="#galeryCarouselIndicators" data-slide-to="1" onclick="seeGaleryModal('galeryModal')"></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2015/04/01/01/56/bora-bora-701862_640.jpg" alt="">
                    </div>
                    <div class="__images_3">
                        <div class="__galery_masque" data-target="#galeryCarouselIndicators" data-slide-to="2" onclick="seeGaleryModal('galeryModal')"></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2017/07/26/19/42/bora-bora-2542917_640.jpg" alt="">
                    </div>
                    <div class="__images_4">
                        <div class="__galery_masque" data-target="#galeryCarouselIndicators" data-slide-to="3" onclick="seeGaleryModal('galeryModal')"></div>
                        <img class="__img" src="https://cdn.pixabay.com/photo/2020/11/28/02/17/lagoon-5783445_640.jpg" alt="">
                    </div>
                    <div class="__images_5">
                        <div class="__galery_masque" data-target="#galeryCarouselIndicators" data-slide-to="4" onclick="seeGaleryModal('galeryModal')"></div>
                        <button class="__galery_more" data-toggle="modal" data-target="#galeryModal">
                            <span class="__icon"><i class="fa-solid fa-images"></i></span>
                            <span class="__text">Afficher toutes les photos</span>
                        </button>
...
<div class="modal fade" id="galeryModal" tabindex="-1" role="dialog" aria-labelledby="galeryModalLabel" aria-hidden="true">
    <div class="modal-dialog __modal_full_screen" role="document">
        <div class="modal-content __content">
            <div class="modal-header __modal_header">
                <p class="modal-title __modal_title" id="galeryModalLabel">
                    <span class="__number" id="number_photo"></span>
                    <span class="__text" id="masculin_feminin"></span>
                </p>
                <button type="button" class="close __modal_close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div id="galeryCarouselIndicators" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators __indicator" id="indicators_carousel">
                        <!-- <li data-target="#galeryCarouselIndicators" data-slide-to="0" class="active"></li>
                        <li data-target="#galeryCarouselIndicators" data-slide-to="1"></li>
                        <li data-target="#galeryCarouselIndicators" data-slide-to="2"></li>
                        <li data-target="#galeryCarouselIndicators" data-slide-to="3"></li>
                        <li data-target="#galeryCarouselIndicators" data-slide-to="4"></li> -->
                    </ol>
                    <div class="carousel-inner __inner" id="carousel_inner">
                        ...
                        <div class="carousel-item">
                            <div class="__images">
                                <img class="__img" src="https://cdn.pixabay.com/photo/2018/04/27/08/56/water-3354063_640.jpg" alt="">
                            </div>
                        </div> -->

                    </div>
                    <a class="carousel-control-prev" href="#galeryCarouselIndicators" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#galeryCarouselIndicators" role="button" data-slide="next">
