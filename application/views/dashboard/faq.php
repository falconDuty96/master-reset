            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row pt-3 mt-3" style="height: 600px ;background-color: white ;overflow-y: auto ;">
                        <div class="col-md-5">
                            <?php echo form_open_multipart("Dashboard/faqAdding", array('class' => "form-group p-4")) ?>
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <span class="textToBold">FAQ Type</span>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <span class="textToBold">FAQ Question</span>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <span class="textToBold">FAQ Contenu</span>
                                </div>
                                <div class="col-md-8">
                                    <textarea class="input-wysiwyg" name="faq_contenu"></textarea>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-md-4">
                                ...
                                <?php if (isset($faq)) : ?>
                                    <?php for ($i = 0; $i < count($faq); $i++) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $faq[$i]->faq_contenu; ?></td>
                                            <td>
                                                <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $faq[$i]->faq_id ?>">Modifier</a>
                                                <a href="<?= base_url() ;?>Dashboard/dropFAQ/<?php echo $faq[$i]->faq_id ?>" class="btn btn-danger">Supprimer</a>
                                            </td>
                                        </tr>

                                        <!-- The Modal -->
                                        <div class="modal fade" id="myModal<?php echo $faq[$i]->faq_id ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <!-- Modal body -->
                                                    <div class="modal-body">
                                                        <?php echo form_open("Dashboard/modifFAQ/{$faq[$i]->faq_id}"); ?>
                                                        <div class="row mb-2">
                                                            <div class="col-md-4">
                                                                <span class="textToBold">FAQ Type</span>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <select class="form-select" name="faq_type">
                                                                    <option value="<?php echo $faq[$i]->faq_type; ?>"><?php echo $faq[$i]->faq_type; ?>s</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2">
                                                            <div class="col-md-3">
                                                                <span class="textToBold">Question</span>
                                                            </div>
                                                            <div class="col-md-9">
                                                                <input type="text" name="faq_question" class="form-control" value="<?php echo $faq[$i]->faq_question; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2">
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="input-wysiwyg" name="faq_contenu"><?php echo $faq[$i]->faq_contenu; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
