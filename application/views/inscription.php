    ...
    <section class="register-photo">
        <div class="border rounded form-container">
            ...
            <?php echo form_open("Users/insertUsers", array("class" => "border rounded")) ; ?>
                ...
                <div class="form-group">
                    <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1"><label class="form-check-label" for="formCheck-1">J'accepte les<a href="<?php echo base_url() ;?>Home/cgv">&nbsp;CGV</a>&nbsp;</label></div>
                </div>
                <div class="form-group">
