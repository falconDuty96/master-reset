...
<head>
	...
	<title>Igoguide | Inscription</title>
    ...
    <section class="register-photo">
        <div class="border rounded form-container">
            ...
            <?php echo form_open("Users/insertUsers", array("class" => "border rounded")) ; ?>
                ...
                <div class="form-group">
                    <input class="border rounded form-control tocompare" id="tocompare1" type="password" placeholder="Mot de passe" name="users_motdepasse">
                    <?php echo form_error('users_motdepasse'); ?>
                </div>
                <div class="form-group">
                    <input class="border rounded form-control tocompare" id="tocompare2" type="password" placeholder="Confirmer mot de passe" name="users_motdepasse">
                    <?php echo form_error('users_motdepasse'); ?>
                </div>
                ...
                <a class="already" href="<?php echo base_url() ;?>Home/loginUsers">J'ai déjà un compte. Se connecter</a>
