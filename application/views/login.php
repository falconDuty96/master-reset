...
<head>
	...
	<title>Igoguide | Connection Pro</title>
...
<body class="bg-beige">
    ...
    <div class="elem-design" style="background-image: url('<?php echo base_url() ;?>publics/image/Connection/header3.webp') ;">
    </div>

    <section class="login-clean design-miakatra" id="form-login-pro">
        <?php echo form_open("Users/ConnectUsers", array("class" => "bg-dark")) ;?>
            ...
            <div class="d-flex justify-content-center mb-3 position-relative">
                <img src="<?php echo base_url() ;?>publics/image/logo.png" style="width: 100px;" alt="">
            
                <p class="__pro">
                    <span class="__icon"><i class="fa-solid fa-crown"></i></span>
                    
                    <span class="__text text-white">PRO</span>
                </p>
            </div>
            ...
            <div class="form-group">
				<a class="btn __btn btn-block" href="<?php echo base_url() ;?>Home/connectProfessionnel">S'inscrire</a>
			</div><a class="forgot text-white" href="#">Mot de passe oublié ?</a>
