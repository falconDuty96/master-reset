...
<body>
    ...
    <div class="main">
        <div class="wrapper">
            <div class="sidebar">
                ...
                <div class="mt-4">
                    ...
                    <div class="pt-2">
                        ...
                        <a href="<?php echo base_url() ?>pro/faq" class="sidebar-link active">
            ...
            <main class="content">
                <!-- FAQ ! -->
                <div class="py-2" style="overflow: hidden; background-color: #fee085; background-color: white; min-height: 700px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <h2 class="text-center mb-4 entete_row entete_row_primary">F.A.Q</h2>
                                <?php if (isset($faq)) : ?>
                                    <?php for ($i = 0; $i < count($faq); $i++) : ?>
                                        <button class="accordion"><?= $faq[$i]->faq_question; ?></button>
                                        <div class="panel">
                                            <?= $faq[$i]->faq_contenu; ?>
                                        </div>
                                    <?php endfor; ?>
