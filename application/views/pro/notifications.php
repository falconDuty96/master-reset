        ...
        <div class="sidebar">
                ...
                <div class="mt-4">
                    ...
                    <div class="pt-2">
                        ...
                        <a href="<?php echo base_url()?>pro/notifications" class="sidebar-link active">
            ...
            <main class="content">
                <h1 class="h3">Liste de notifications</h1>
                <div class="form-container shadow shadow-sm">
                    <h6 class="form-title d-flex justify-content-between">
                        <span>Liste de notifications</span>
                        <span>
                            <!-- <button class="_btn _btn-primary" onclick="createEmails()">
                <i class="fa-solid fa-plus"></i>
                <span>Ajouter</span>
            </button> -->
                            <button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#modal-notifications" id="open-modal-notifications"></button>
                        </span>
                    </h6>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Non lu</td>
                                        <td>
                                            <span role="button" onclick="createNotifications()" class="btn-tooltip text-success" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Voir">
                ...
                <!-- Modal -->
                <div class="modal fade" id="modal-notifications" tabindex="-1" aria-labelledby="modal-notifications" aria-hidden="true" data-bs-backdrop="static">
                    <div class="modal-dialog" id="form-header">
                        ...
                        <form class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <button type="button" id="close-modal-notifications" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="header-content">
                                    <p class="bolder">Client: </p>
                                    <p>ketaka@gmail.com</p>
                                </div>
                                <div class="body-content">
                                    <p class="bolder">Etablissement:</p>
                                    <p>Mamaliza</p>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="_btn _btn-success w-100">Fermer</button>
                            </div>
                        </form>
