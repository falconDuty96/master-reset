...
<body class="">
    ...
    <div class="main">
        <div class="wrapper">
            <div class="sidebar">
                ...
                <div class="mt-4">
                    ...
                    <div class="pt-2">
                        ...
                        <a href="<?php echo base_url() ?>pro/transactions" class="sidebar-link active">
            ...
            <main class="content">
                <h1 class="h3">Nouvelle transaction</h1>
                <div class="form-container shadow shadow-sm">
                    <h6 class="form-title d-flex justify-content-between">
                        ...
                        <span>
                            <!-- <button class="_btn _btn-primary" onclick="createTransactions()">
                <i class="fa-solid fa-plus"></i>
                <span>Ajouter</span>
            </button> -->
                            <button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#modal-transactions" id="open-modal-transactions"></button>
                        </span>
                    </h6>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>22/02/2023</td>
                                        <td>
                                            <p class="pending w-50 text-center bolder">En cours</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Mamaliza</td>
                                        ...
                                        <td>22/02/2023</td>
                                        <td>
                                            <p class="success w-50 text-center bolder">Effectué</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Mamaliza</td>
                                        ...
                                        <td>22/02/2023</td>
                                        <td>
                                            <p class="rejected w-50 text-center bolder">Rejeté</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <!-- Modal -->
                <div class="modal fade" id="modal-transactions" tabindex="-1" aria-labelledby="modal-transactions" aria-hidden="true" data-bs-backdrop="static">
