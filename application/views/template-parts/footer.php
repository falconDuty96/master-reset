	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<img class="logo-footer mb-2" src="<?php echo base_url() ?>publics/image/logo.png" alt="logo Igoguide">
			...
			<div class="col-md-2 col-sm-6">
				...
				<ul class="my-list">
					...
					<li>
						<a href="<?php echo base_url(); ?>Home/loginUsers">Se connecter</a>
					</li>
					<li>
						<a href="<?php echo base_url(); ?>Home/loginProfessionnel">Espace pro</a>
					</li>
				</ul>
			</div>
			...
			<div class="col-md-3 col-sm-6">
				...
				<ul class="my-list">
					<li>
						<div class="media">
							<img class="mr-3 img-mo" src="<?php echo base_url() ?>publics/image/au_fil_de_l_eau.png" alt="Generic placeholder image">
			...
			<div class="modal-body">
				...
				<ul class="list-group">
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/cabane_arbres.png" style="height:45px;width: 45px;" alt="">
					...
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/cabane_sous_terre.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Cabane sous terre</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/cabane_sur_terre.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Cabane sur terre</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/cabane_sur_l_eau.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Cabane sur l'eau</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bulle.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Bulles</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/tipis_tente_yourte.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Tipis / tente / Yourte</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/habitat_roulant.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Habitas roulants</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/monument_historique.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Monuments historiques</a>
						</div>
					</li>
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bateau.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
					...
					<li class=" list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/hotels_atypiques.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul class="list-group">
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bar_whiskies.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Lounges / Whiskies / Cocktails</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bar_rooftop.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Bars à rooftop</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bar_vin.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Bars à vins</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bar_pubs _ tapas.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Pubs / Bars à tapas</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bar_billard.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Bars à thèmes / Jeux / Billards</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/concert_bar.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Concerts bars</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/bar_chat.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul class="list-group">
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/restaurants_originaux.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Restaurants originaux</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/restaurants_annimation.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Restaurants avec animations</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/brasserie_bistrot.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Brasserie - Bistrot - Auberges</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/cuisine_traditionnelle.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Cuisines traditionnelles</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/cuisine_monde.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Cuisines du monde</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/type_fast_food.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul class="list-group">
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/au_fil_de_l_eau.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Au fil de l'eau</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/perles_sauvages.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
					...
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/jardins_imaginaire.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul class="list-group">
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/organisateurs.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Organisateurs</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/photographe.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Photographes etc.</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/traiteur.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class=" ml-2" style="font-size: 13px;">Traiteurs</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/fleuriste.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Fleuristes</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/location_voiture.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Locations de véhicules</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/location_velo.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
							<a href="" class="ml-2" style="font-size: 13px;">Locations de vélos</a>
						</div>
					</li>
					<li class="list-group-item list-v-center">
						<img class="" src="<?php echo base_url() ?>publics/image/divers_pressing.png" style="height:45px;width: 45px;" alt="">
						<div class="pl-1">
